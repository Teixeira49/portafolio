...
part 'package:portafolio/src/core/variables/constants/color_constants.dart';
...
class ColorValues {
  ...
  static final _textDisabledAlt = _ColorScheme(
    light: _ColorConstants.brandSecond.shade400,
    dark: _ColorConstants.brandSecond.shade500,
  );

  static final _textBrandPrimary = _ColorScheme(
    light: _ColorConstants.brandFirstColor,
    dark: _ColorConstants.grayDark.shade50,
  );

  static final _textBrandSecondary = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade700,
  ...
  static final _textBrandTertiary = _ColorScheme(
    ...
    dark: _ColorConstants.grayDark.shade400,
    altLight: _ColorConstants.brandFirstColor.shade600,
    altDark: _ColorConstants.grayDark.shade400,
  );

  static final _textTitlePrimary = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade50,
    dark: _ColorConstants.brandFirstColor.shade900,
  );

  static final _textTitleSecondary = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade700,
    dark: _ColorConstants.grayDark.shade300,
  );

  static final _textTitleTertiary = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade600,
    dark: _ColorConstants.grayDark.shade400,
    altLight: _ColorConstants.brandFirstColor.shade600,
    altDark: _ColorConstants.grayDark.shade400,
  ...
  /// This can be changed to gray-400, but gray-500 is higher contrast
  /// and more accessible.
  static Color darkBrand(BuildContext context) =>
      _textDisabledAlt.getColor(context);
  ...
  /// Primary brand text useful for headings (e.g. cards in pricing page
  /// headers).
  static Color textTitlePrimary(BuildContext context) =>
      _textTitlePrimary.getColor(context);

  /// Secondary brand text for accented text, highlights, and subheadings
  /// (e.g. subheadings in blog post cards).
  static Color textTitleSecondary(BuildContext context) =>
      _textTitleSecondary.getColor(context);

  /// Tertiary brand text for lighter accented text and highlights
  /// (e.g. numbers in metric cards).
  static Color textTitleTertiary(BuildContext context) =>
      _textTitleTertiary.getColor(context);
  ...
  static final _borderBrand = _ColorScheme(
    ...
    altLight: _ColorConstants.brandFirstColor.shade300,
  ...
  static final _bgBrandSecondary = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade100,
    dark: _ColorConstants.brandFirstColor.shade600,
  );
  ...
  static final _bgBrandSection = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade800,
    dark: _ColorConstants.grayDark.shade800,
    subtleLight: _ColorConstants.brandFirstColor.shade700,
    subtleDark: _ColorConstants.grayDark.shade900,
  );
  ...
  static final _utilityBrand100 = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade100,
    dark: _ColorConstants.brandFirstColor.shade900,
    altLight: _ColorConstants.brandFirstColor.shade100,
    altDark: _ColorConstants.grayDark.shade800,
  );

  static final _utilityBrand200 = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade200,
    dark: _ColorConstants.brandFirstColor.shade800,
    altLight: _ColorConstants.brandFirstColor.shade200,
    altDark: _ColorConstants.grayDark.shade700,
  );

  static final _utilityBrand300 = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade300,
    dark: _ColorConstants.brandFirstColor.shade700,
    altLight: _ColorConstants.brandFirstColor.shade300,
    altDark: _ColorConstants.grayDark.shade700,
  );

  static final _utilityBrand400 = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade400,
    dark: _ColorConstants.brandFirstColor.shade600,
    altLight: _ColorConstants.brandFirstColor.shade400,
  ...
  static final _utilityBrand500 = _ColorScheme(
    light: _ColorConstants.brandFirstColor,
    dark: _ColorConstants.brandFirstColor,
    altLight: _ColorConstants.brandFirstColor,
  ...
  static final _utilityBrand700 = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade700,
    dark: _ColorConstants.brandFirstColor.shade300,
    altLight: _ColorConstants.brandFirstColor.shade700,
    altDark: _ColorConstants.grayDark.shade300,
  );

  static final _utilityBrand800 = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade800,
    dark: _ColorConstants.brandFirstColor.shade200,
    altLight: _ColorConstants.brandFirstColor.shade800,
    altDark: _ColorConstants.grayDark.shade200,
  );

  static final _utilityBrand900 = _ColorScheme(
    light: _ColorConstants.brandFirstColor.shade900,
    dark: _ColorConstants.brandFirstColor.shade100,
    altLight: _ColorConstants.brandFirstColor.shade900,
    altDark: _ColorConstants.grayDark.shade100,
  );
  ...
  static final _tagAlterGreenFg = _ColorScheme(
    light: _ColorConstants.greenSecondaryConstant.shade600,
    dark: _ColorConstants.greenSecondaryConstant.shade600,
  );

  static final _tagAlterGreenBg = _ColorScheme(
    light: _ColorConstants.greenSecondaryConstant.shade100,
    dark: _ColorConstants.greenSecondaryConstant.shade800,
  );

  static final _tagBlueSecondaryFg = _ColorScheme(
    light: _ColorConstants.blueSecondaryConstant.shade600,
    dark: _ColorConstants.blueSecondaryConstant.shade600,
  );

  static final _tagBlueSecondaryBg = _ColorScheme(
    light: _ColorConstants.blueSecondaryConstant.shade100,
    dark: _ColorConstants.blueSecondaryConstant.shade800,
  );
  ...
  static Color tagAlterGreenFg(BuildContext context) =>
      _tagAlterGreenFg.getColor(context);

  static Color tagAlterGreenBg(BuildContext context) =>
      _tagAlterGreenBg.getColor(context);

  static Color tagBlueSecondaryFg(BuildContext context) =>
      _tagBlueSecondaryFg.getColor(context);

  static Color tagBlueSecondaryBg(BuildContext context) =>
      _tagBlueSecondaryBg.getColor(context);
