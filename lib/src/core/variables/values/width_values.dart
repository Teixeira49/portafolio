part 'package:portafolio/src/core/variables/constants/width_constants.dart';
...
class WidthValues {
  ...
  /// Ultra small radius (0.25)
  static final radiusXx = _WidthConstants.spacing.getSpacing(0.25);
  ...
  /// Ultra small spacing (0.25)
  static final spacingXx = _WidthConstants.spacing.getSpacing(0.25);

  /// Extra extra small spacing (0.5)
  static final spacingXxs = _WidthConstants.spacing.getSpacing(0.5);

  /// Extra small spacing (0.5)
  static final spacingXss = _WidthConstants.spacing.getSpacing(0.95);
