...
class AppTheme {
  static ThemeData theme(BuildContext context, Brightness? myBrightness) {
    ...
    return ThemeData(
        ...
        scrollbarTheme: _CustomThemeValues.scrollBarTheme(context),
    );
  }
}
...
class _CustomThemeValues {
  ...
  static TextSelectionThemeData textSelectionTheme(BuildContext context) =>
      TextSelectionThemeData(
        ...
        selectionColor: ColorValues.tagBlueBg(context),
        selectionHandleColor: ColorValues.tagBlueFg(context),
      );
